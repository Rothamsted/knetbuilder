...
import info.marcobrandizi.rdfutils.jena.elt.RDFBatchProcessor;
 ...
 *
 */
public class RDFExporter extends RDFBatchProcessor<ONDEXGraph>
{
	@Override
	...
	{
		RDFXFactory xfact = new RDFXFactory ( this.getBatchFactory ().get () );
		...
		xfact = this.handleNewXBatch ( xfact, true );
		...
		this.handleNewXBatch ( xfact, true );
	...
	private RDFXFactory handleNewXTask ( RDFXFactory xfact ) {
		return handleNewXBatch ( xfact, false );
	}
	...
	private RDFXFactory handleNewXBatch ( RDFXFactory xfact, boolean forceFlush )
	{
		...
		Model newModel = super.handleNewBatch ( currentModel , forceFlush );

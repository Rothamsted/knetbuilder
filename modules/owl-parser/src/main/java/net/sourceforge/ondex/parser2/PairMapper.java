 ...
 * of data source only and here we have two of them. There are mappers (e.g., {@link ConceptMapper} for which it is clear that only one of the two parameters passed 
 * to the pair mapper might need to be tested for already-done visits, and in that cases the mapper can extend/implement
 * both this interface and {@link Visitable}.
 *
 * @author brandizi

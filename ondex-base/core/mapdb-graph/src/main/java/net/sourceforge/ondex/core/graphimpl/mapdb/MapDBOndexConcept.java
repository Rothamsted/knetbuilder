...
//
///**
// * This class represents a pure memory based implementation of the ONDEXConcept. It uses standard JAVA datatypes.
// * 
// * @author taubertj
// * @author Matthew Pocock
// */
//public class MapDBOndexConcept extends AbstractConcept implements Comparable<MapDBOndexConcept>
//{
//
//	private static final long serialVersionUID = 4938832924023254949L;
//
//	// Concept names
...
//
//	/**
//	 * Constructor which fills all fields of Concept and initialise empty HashMap for possible concept names and concept
//	 * accessions
//	 * 
//	 * @param graph
//	 *          parent ONDEXGraph
...
//	 */
//	MapDBOndexConcept ( long sid, ONDEXGraph graph, int id, String pid, String annotation, String description,
...
//
//	@Override
//	public int compareTo ( MapDBOndexConcept o )
//	{
...
//	{
//		return graph.conceptToTags.get ( this ).remove ( concept ) && graph.tagToConcepts.get ( concept ).remove ( this );
//	}
//
//	@Override
//	protected boolean removeConceptAccession ( String accession, DataSource elementOf )
//	{
//
...
//			if ( ca.getAccession ().equals ( accession ) && ca.getElementOf ().equals ( elementOf ) )
//			{
//
...
//	{
//		Set<ONDEXConcept> existingAttribute = graph.attributeNameToConcepts.get ( attrname );
...
//
//	@Override
//	protected ConceptAccession retrieveConceptAccession ( String accession, DataSource elementOf )
//	{
//
...
//		if ( existing != null )
//		{
//			graph.fireEventOccurred (
//					new DuplicatedEntryEvent ( Config.properties.getProperty ( "memory.Concept.DuplicatedConceptAttribute" )
//							+ attribute.getOfType ().getId (), "[Concept - storeConceptAttribute]" ) );
//		}
//

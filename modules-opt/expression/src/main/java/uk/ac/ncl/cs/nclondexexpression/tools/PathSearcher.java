...
public class PathSearcher {
	 ...
	 */
	private Vector<IntArrayList> paths = new Vector<IntArrayList>();
	...
	/**
	 * constructor.
	 * @throws IllegalArgumentExce(ption if ccs.length != rts.length + 1
	 */
...
//		og = OndexPlugin.getInstance().getOndexGraph();
	 ...
	 * 
	 */
	private void traceback(PathNode pn, IntArrayList a) {
		a.add(pn.cid);
		if (pn.parent != null) {
			a.add(pn.rid);

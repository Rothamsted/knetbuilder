...
import net.sourceforge.ondex.parser.kegg53.data.Graphics;
...
public class Handler extends DefaultHandler {
    ...
    public void startElement(String uri, String name, String qName,
        ...
        if (element.equalsIgnoreCase("component")) {
            ...
            if (comp == null) {
                System.err.println("Inconsistency in pathway " + pathway.getId()
        ...
        if (element.equalsIgnoreCase("reaction")) {
            ...
            for (String reactionName : spacePattern.split(atts.getValue("name"))) {
                reaction = new Reaction(reactionName, type);
            }
        }
